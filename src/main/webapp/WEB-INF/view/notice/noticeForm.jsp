	...
	<div id="mypage">
		...
		<div class="center_cover">
					...
					<table class="mypage_table_head">
						<c:if test="${amem.adminchk!=1 || boardid eq '3'}">
							<caption>
								...
								<span class="mth_left"> 1:1 친절상담은 KIC AUCTION에 대한 문의내용이나
									요청사항을 처리해 드리는 질문답변 게시판입니다.<br> 최대한 상세히 문의해 주시면 좀더 정확한 답변을
									드릴 수 있습니다.
								</span>
					...
					<form id="frm" action="noticePro" method="post"
						...
						<table class="indiv_table" style="margin-top: 12px;">
							...
							<tbody>
								<tr>
									<th>제목</th>
									<td><input type="text" class="input_mtmtitle"
										name="subject" id="qna_title" maxlength="40" value=""></td>
								...
								<tr>
									<th>작성자</th>
									<td><input type="text" class="input_mtmtitle"
										name="subject" id="qna_title" maxlength="40" value="${amem.id }"></td>
								...
								<tr>
									<th>비밀번호</th>
									<td><input type="password" class="input_mtmtitle"
										style="width: 10%;" name="pass" id="qna_title" maxlength="40"
										value=""></td>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											<label for="isPublic"></label> <input type="checkbox"
												id="isPublicCheckbox"> 체크 Y:공개 / N:비공개 <input
												type="hidden" id="isPublic" name="isPublic" value="N">
											<!-- 기본값은 'N'으로 설정 -->
										</div>
									</td>
								...
								<tr>
									<th>내용</th>
									<td>
										<div style="display: none;"></div> <textarea
											class="input_mtmstate" name="content" id="qna_contents"
											title="질문내용"></textarea>
										<div class="form-group">
								...
								<tr>
									<td colspan="2" class="austria" style="border-bottom: none;"><button
											type="submit" class="btn_luxemberg cursor_p">문의하기</button></td>
								</tr>
							</tbody>
						</table>
					</form>
			...
			<script>
				...
				document.getElementById('isPublicCheckbox').addEventListener(
						'change',
						function() {
							var isPublicInput = document
