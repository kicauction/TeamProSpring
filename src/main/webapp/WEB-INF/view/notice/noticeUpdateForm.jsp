	...
	<div id="mypage">
		...
		<div class="center_cover">
			...
			<li style="margin-bottom:20px">
				...
				<form  id="frm" action="noticeUpdatePro" method="post"
			enctype="multipart/form-data">
				<table class="indiv_table" style="margin-top:12px;">
					...
					<tbody><tr>
						<th>제목</th>
						<td> <input type = "hidden" name = "num" value="${notice.num}">
						<input type="text" class="input_mtmtitle" name="subject" id="qna_title" maxlength="40" value="${notice.subject}"></td>
					
				
					</tr>
					<tr>
						<th>작성자</th>
						<td> <input type = "hidden" name = "name" value="${notice.name }">
						<input type="text" class="input_mtmtitle" name="subject" id="qna_title" maxlength="40" value="${notice.subject}"></td>
					...
					<tr>
						<th>비밀번호</th>
						<td><input type="password" class="input_mtmtitle"  style="width:10%;" name="pass" id="qna_title" maxlength="40" value="">
						</td>
        ...
        <input type="checkbox" id="isPublicCheckbox"> 체크 Y:공개 / N:비공개
        <input type="hidden" id="isPublic" name="isPublic" value="N"> <!-- 기본값은 'N'으로 설정 -->
						...
						<td>
							...
							<textarea class="input_mtmstate" name="content" id="qna_contents" title="질문내용">${notice.content}</textarea>
				...
				<label for="file">파일:</label> <input type="file"
					...
					<tr>
						<td colspan="2" class="austria" style="border-bottom:none;"><button type="submit" class="btn_luxemberg cursor_p">수정하기</button></td>
					</tr>
				</tbody></table></form>
			</li>
